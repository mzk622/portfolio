...
`;function L(t,e){return n=>n?t():e()}function z(t){return L(t,(()=>null))}var I=t=>{const{cascade:e=!1,damping:n=.5,delay:r=0,duration:i=1e3,fraction:s=0,keyframes:l=N,triggerOnce:c=!1,className:u,style:d,childClassName:f,childStyle:p,children:m,onVisibilityChange:g}=t,v=(0,a.useMemo)((()=>function({duration:t=1e3,delay:e=0,timingFunction:n="ease",keyframes:a=N,iterationCount:r=1}){return o.iv`
