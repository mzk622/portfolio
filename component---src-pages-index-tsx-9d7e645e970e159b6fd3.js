...
`;function L(t,e){return n=>n?t():e()}function I(t){return L(t,(()=>null))}var z=t=>{const{cascade:e=!1,damping:n=.5,delay:r=0,duration:i=1e3,fraction:s=0,keyframes:l=O,triggerOnce:c=!1,className:u,style:d,childClassName:f,childStyle:p,children:m,onVisibilityChange:g}=t,v=(0,a.useMemo)((()=>function({duration:t=1e3,delay:e=0,timingFunction:n="ease",keyframes:a=O,iterationCount:r=1}){return o.iv`
...
`;var tt=t=>{const{big:e=!1,direction:n,reverse:r=!1,...o}=t,i=(0,a.useMemo)((()=>function(t,e,n){switch(n){case"bottom-left":return e?V:Z;case"bottom-right":return e?Y:S;case"down":return t?e?X:k:e?$:N;case"left":return t?e?W:E:e?D:O;case"right":return t?e?q:P:e?U:_;case"top-left":return e?Q:F;case"top-right":return e?G:T;case"up":return t?e?K:M:e?J:j;default:return e?R:C}}(e,r,n)),[e,n,r]);return x(z,{keyframes:i,...o})};o.F4`
  from {
