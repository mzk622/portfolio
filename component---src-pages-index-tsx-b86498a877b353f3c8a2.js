...
`;function L(t,e){return n=>n?t():e()}function I(t){return L(t,(()=>null))}var z=t=>{const{cascade:e=!1,damping:n=.5,delay:r=0,duration:i=1e3,fraction:s=0,keyframes:l=k,triggerOnce:c=!1,className:u,style:d,childClassName:f,childStyle:p,children:m,onVisibilityChange:g}=t,v=(0,a.useMemo)((()=>function({duration:t=1e3,delay:e=0,timingFunction:n="ease",keyframes:a=k,iterationCount:r=1}){return o.iv`
...
`;var tt=t=>{const{big:e=!1,direction:n,reverse:r=!1,...o}=t,i=(0,a.useMemo)((()=>function(t,e,n){switch(n){case"bottom-left":return e?V:Z;case"bottom-right":return e?Y:S;case"down":return t?e?D:O:e?X:N;case"left":return t?e?U:E:e?W:k;case"right":return t?e?$:P:e?q:_;case"top-left":return e?Q:j;case"top-right":return e?J:F;case"up":return t?e?K:M:e?G:T;default:return e?R:C}}(e,r,n)),[e,n,r]);return x(z,{keyframes:i,...o})};o.F4`
  from {
